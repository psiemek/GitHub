...
extern INT send_ipaddress(void *var);
extern INT send_netmask(void *var);
extern INT send_gateway(void *var);
extern INT send_macaddress(void *var);
extern INT send_modbusport(void *var);
extern INT send_modbusaddr(void *var);
...
#ifndef IPADDRESS
#define IPADDRESS    \
    {"ipaddress",send_ipaddress}
#endif

#ifndef NETMASK
#define NETMASK    \
    {"netmask",send_netmask}
#endif

#ifndef GATEWAY
#define GATEWAY    \
    {"gateway",send_gateway}
#endif

#ifndef MACADDRESS
#define MACADDRESS    \
    {"macaddress",send_macaddress}
#endif

#ifndef MODBUSPORT
#define MODBUSPORT    \
    {"modbusport",send_modbusport}
#endif

#ifndef MODBUSADDR
#define MODBUSADDR    \
    {"modbusaddr",send_modbusaddr}
#endif
